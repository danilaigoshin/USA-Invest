...
import { StockHistory, Theme } from '../../store/interfaces';
...
interface IProps {
  dropdownList: StockHistory[];

  selectedItem: StockHistory;

  dropdownHandler: (item: StockHistory) => void;
}

const DropdownHistory: FC<IProps> = ({
  dropdownList,
  selectedItem,
  dropdownHandler,
}) => {
  ...
  const selectHandler = (item: StockHistory) => {
