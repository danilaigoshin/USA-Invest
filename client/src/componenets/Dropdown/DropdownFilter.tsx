...
interface IProps {
  dropdownList: IDropDownHandler[];

  selectedItem: IDropDownHandler;

  dropdownHandler: (item: any) => void;

  zIndex?: number;
}

const DropdownFilter: FC<IProps> = ({
  dropdownList,
  selectedItem,
  dropdownHandler,
  zIndex,
  ...
  const selectHandler = (item: IDropDownHandler) => {
  ...
  return (
    <>
      <div ref={dropdownEl} className="dropdown">
        ...
        <DropdownMenu>
          <div style={{ zIndex }} className="dropdown-menu">
